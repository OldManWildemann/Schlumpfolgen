print()
print("SchnulpFolgen 4.4D by gismo.pracht@proton.me")
...
pftimeout = 120 # Timeout fuer Primfaktorzerlegung
purge = 10 # clear attractors each xth report cycle
###############################################################
...
while True:
    ...
    if base%report==0: 
            ...
            purgecnt+=1
            if purgecnt>=purge:
                print("Attractors len=",len(attractors),"purged.")
                purgecnt=0
                attractors.clear()
                for myloop in looopstartbymin:
